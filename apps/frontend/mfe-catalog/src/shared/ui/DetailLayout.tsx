  ...
  return (
    <div className="h-full flex flex-col bg-white min-h-screen">
        ...
        {headerContent ? (
          ...
          <>
            <div className="flex items-center gap-4">
              <div
                className={`w-9 h-9 ${isJob ? "bg-green-100 text-green-700" : "bg-[#e8f0fe] text-[#1a73e8]"} rounded-lg flex items-center justify-center font-bold shadow-sm`}
              >
                {isJob ? "J" : "T"}
              </div>
              <div>
                ...
                <h1 className="text-xl font-medium text-[#202124] flex items-center gap-2">
                  {title}
                  <span className="text-lg text-[#bdc1c6] cursor-pointer hover:text-[#f4b400] transition-colors font-normal">
                    ☆
                  </span>
                </h1>
              </div>
            ...
            <div className="flex gap-8 items-center">
              ...
              <div className="flex flex-col items-end">
                <span className="text-[10px] text-[#5f6368] font-bold uppercase mb-0.5">
                  Lifecycle
                </span>
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-7xl px-8 py-6">{children}</div>
      </main>
    </div>
  );
};
