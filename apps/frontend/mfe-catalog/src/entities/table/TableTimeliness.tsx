    ...
    <div className="space-y-8 animate-fade-in">
      <div className="bg-white rounded-lg border border-[#dadce0] p-8 shadow-sm">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-sm font-bold text-[#5f6368] uppercase tracking-widest">
            Timeliness Overview
          </h3>
        ...
        {dailyHistory.length === 0 ? (
          <div className="p-16 text-center bg-[#f8f9fa] border border-dashed border-[#dadce0] rounded-lg">
            ...
            <p className="text-[#5f6368] text-sm">No activity records for the last {days} days.</p>
          </div>
        ) : (
          <div className="h-48">
            <ReactECharts
      ...
      {selectedDay && (
        <div className="bg-white rounded-lg border border-[#dadce0] p-8 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-sm font-bold text-[#5f6368] uppercase tracking-widest">
              Hourly Detail • {selectedDay}
            </h3>
            <button
              onClick={() => setSelectedDay(null)}
              className="text-[#5f6368] hover:text-[#202124] text-xs"
            >
              ✕ Close
            </button>
          </div>
          ...
          <div className="mt-6 flex gap-6 text-[10px] font-bold text-[#5f6368] uppercase tracking-wider justify-center">
            <div className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded bg-[#1e8e3e]"></span> Success
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded bg-[#f9ab00]"></span> Warning
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded bg-[#d93025]"></span> Failed
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded bg-[#f1f3f4]"></span> Missing
            </div>
          </div>
        </div>
      )}
