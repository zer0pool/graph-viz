...
export const VisitHistoryCard: React.FC<VisitHistoryCardProps> = ({
  title,
  subtitle,
  icon: Icon,
            ...
            {loading ? (
              ...
              <div className="space-y-1">
                {items.map((item, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* Optional: Add numbering for Top Visited if needed via props or CSS */}
                      <span className="text-sm font-medium text-blue-600 group-hover:underline truncate max-w-[200px]">
