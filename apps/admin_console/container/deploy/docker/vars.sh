...
export INFRA_VARS='$BASE_URL $BASE_URL_PREFIX $REDIRECT_COMMAND $API_LOCATION_REGEX $SUBPATH_REDIRECT_BLOCK $NAMESERVER $BACKEND_HOST $MFE_LINEAGE_UPSTREAM $MFE_CATALOG_UPSTREAM'
