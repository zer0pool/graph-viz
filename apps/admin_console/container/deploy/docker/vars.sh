...
export APP_VARS='$API_BASE_URL $BASE_URL $ENABLE_MFE_LINEAGE $ENABLE_MFE_CATALOG $LINEAGE_MFE_URL $CATALOG_MFE_URL $ENABLE_AUTH $OIDC_AUTHORITY $OIDC_CLIENT_ID $OIDC_REDIRECT_URI $OIDC_SCOPE $OIDC_CLIENT_SECRET $OIDC_RESOURCE $OIDC_USERINFO_ENDPOINT $OIDC_RESPONSE_TYPE $OIDC_RESPONSE_MODE $OIDC_AUTH_ENDPOINT $OIDC_TOKEN_ENDPOINT'
