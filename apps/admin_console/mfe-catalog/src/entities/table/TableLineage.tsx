      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-[#dadce0] p-6">
          <div className="mb-6 pb-2 border-b border-[#f1f3f4]">
            ...
            <p className="text-[10px] text-[#5f6368] uppercase tracking-wider mt-1.5">Impact and sources providing data to this table.</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-[#dadce0] p-6">
          <div className="mb-6 pb-2 border-b border-[#f1f3f4]">
            ...
            <p className="text-[10px] text-[#5f6368] uppercase tracking-wider mt-1.5">Impact and consumers reading from this table.</p>
          </div>
...
const NodeBox: React.FC<{ type: string; name: string; color?: string }> = ({ name }) => (
  <div className={`p-4 bg-[#e8f0fe] border border-[#d2e3fc] rounded-lg flex items-center gap-3 hover:shadow-md transition-all cursor-default`}>
    <div className={`w-8 h-8 rounded-full bg-white flex items-center justify-center text-[10px] font-bold text-[#174ea6] shadow-sm uppercase`}>
      J
    </div>
    <div className="flex flex-col">
