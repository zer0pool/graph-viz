...
class ProjectService:
    ...
    def get_project_detail(self, project_id: str) -> Dict:
        ...
        return {"project": self._format_project(project), "summary": stats}
    ...
    def list_project_jobs(
        ...
        """
        results, total = self.uow.job_node.find_by_project(project_id, limit, offset)
    ...
    def list_all_projects(self, limit: int = 100) -> List[Dict]:
        ...
        return [
            {"project_id": p["project_id"], "job_count": p["job_count"]}
            for p in projects
        ]
