...
class DataSyncService:
    ...
    async def sync_redis_queue_to_bigquery(self, queue_key: str, table_id: str, batch_size: int = 100) -> int:
        """
        ...
        try:
            ...
            if success:
                ...
                logger.error(f"BigQuery insert failed. Re-queueing {len(events)} records.")
                for event in events:
